            ...
            <div class="navbar">
         	...
         	<div class="mainpanel">
         		<form action="AddBusDriver" method="POST" enctype="multipart/form-data">
	         		<label id="name" for="ans_name">Driver Name</label>
	         		<input type="text" id="ans_name" name="name"><br/>
	         		<label id="licno" for="ans_licno">Driver Licence No</label>
	         		<input type="text" id="ans_licno" name="licno"><br/>
	         		<label id="emailid" for="ans_emailid">Driver Email ID</label>
	         		<input type="email" id="ans_emailid" name="emailid"><br/>
	         		<label id="number" for="ans_number">Driver Phone No</label>
	         		<input type="number" id="ans_number" name="number"><br/>
	         		<label id="fphoto" for="ans_fphoto">DrivingLicence Photo(Front)</label>
	         		<input type="file" multiple accept="image/*" id="ans_fphoto" name="fphoto"><br/>
	         		<label id="bphoto" for="ans_bphoto">DrivingLicence Photo(Back)</label>
	         		<input type="file" multiple accept="image/*" id="ans_bphoto" name="bphoto"><br/>
	         		<label id="health" for="ans_health">Health Certificate</label>
